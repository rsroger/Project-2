...
Ape.prototype.type = "ape";

function Tiger(pos, ch){
  this.pos = pos;
  this.basePos = this.pos = pos.plus(new Vector(0, 0));
  this.size = new Vector(3, 3);
}
Tiger.prototype.type = "tiger";
...
Spider.prototype.act = function(step){
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
...
Ape.prototype.act = function(step){
  this.pos = this.basePos.plus(new Vector(0, 0));
};

Tiger.prototype.act = function(step){
  this.pos = this.basePos.plus(new Vector(0, 0));
};
